...
<div className='d-none' ref={observation}>
    <div className="card  mt-5 ">
        ...
        <div className="card-body d-flex justify-content-between align-items-center"> <label htmlFor="aa1" className='mt-1'>body</label>
            <input className='form-control w-75' id='aa1' ref={cardBody}></input></div>
        <div className="card-footer d-flex justify-content-between align-items-center"> <label htmlFor="aa2" className='mt-1'>Footer</label>
            <input className='form-control w-75' id='aa2'  ref={cardFooter} ></input>
            </div>

    </div>
    <div className="w-100 d-flex justify-content-end"><button type='button' className='btn btn-success mt-3 ml-auto' onClick={addNew}>Add</button></div>
